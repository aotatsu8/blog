...
export const siteConfig = {
  ...
  description: [
    'Hachiです。元フレンチ料理人から、フリーランスのフロントエンドエンジニアに転身しました。',
    'このブログでは、実際に買って使ったガジェット・家電・本を「良い点もイマイチな点も」正直にレビューしています。',
    '最近はAIと一緒にブラウザゲームを作って公開するのにハマり中。作る話も、買う話も、ゆるく発信していきます。',
  ].join('\n'),
  url: rawSiteUrl,
  locale: 'ja_JP',
  /**
